...
function randomEdges(maxE,n){ //generates an array of random edges
  var edge_list = [];
  var vertex_list = [];
  vertex_list.push(0);
  for (i=1;i<n;i++){
...
function Graph(n,edges,weights){ //graph object where "edges" is an edge list
  this.adjacencyMatrix = nullMatrix(n);
  this.weightMatrix = nullMatrix(n);
  this.n = n;
